...
import { Mail, X, Check, Copy, Download, ExternalLink, Loader2, Sparkles, AlertCircle, FileText, Send, User } from 'lucide-react';
import { createGmailDraft, generateItemsHtmlTable } from '../../lib/gmailService';
